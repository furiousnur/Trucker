...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-dashboard"></i> Add Person Rate</h1>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item"><a href="#">Add Person Rate</a></li>
            </ul>
        </div>
                    ...
                    <div class="tile-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Value:</strong>
                                    {!! Form::text('value', null, array('placeholder' => 'e.g., 500','class' => 'form-control')) !!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
